...
-- 7. Update customer contact info (CustomerID)
...
-- 9. Delete orders for a specific customer (CustomerID)
...
/*-- 1. Retrieve a list of all orders along with customer information (customer name)
